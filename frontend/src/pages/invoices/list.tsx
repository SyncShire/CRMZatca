import {getDefaultFilter, HttpError, useGo, useModal, CrudFilters} from "@refinedev/core";
import {
    CreateButton,
    SaveButton,
    DateField,
    ...
    getDefaultSortOrder,
    useSelect,
    useTable, rangePickerFilterMapper,
} from "@refinedev/antd";
import {
    Avatar,
    Flex,
...
import {Invoice, InvoiceFilterVariables} from "@/types";
...
export const InvoicePageList = () => {
        ...
        const {tableProps, searchFormProps, filters, sorters} = useTable<Invoice, HttpError, InvoiceFilterVariables>({
            // onSearch: (params) => {
            ...
            //             field: "invoiceDate",
            //             operator: "gte",
            //             value: invoiceDate ? invoiceDate[0].toISOString() : undefined,
            //         },
            //         {
            //             field: "invoiceDate",
            //             operator: "lte",
            //             value: invoiceDate ? invoiceDate[1].toISOString() : undefined,
            //         },
            //     );
            //     return filters;
            // },
        ...
        return (
            <>
                ...
                {/*    <Form layout="vertical" {...searchFormProps}>*/}
                        ...
                        {/*    <Input placeholder="ID, Name, etc." prefix={<SearchOutlined/>}/>*/}
                        {/*</Form.Item>*/}
                        ...
                        <div style={{width: "100%", minWidth: "1200px"}}>
                            ...
                            >
                                ...
                                <Table.Column
                                    ...
                                    filterDropdown={(props) => (
                                        <FilterDropdown {...props} mapValue={(selectedKeys, event) => {
