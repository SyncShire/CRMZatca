...
import InvoiceStatusesRadial from "@/components/charts/InvoiceStatusesRadial";
import AppointmentsTodayPieChart from "@/components/charts/AppointmentsTodayPieChart";
...
export const DashboardPage: React.FC = () => {
    return (
        <>
            <Row gutter={[16, 16]}>
                <Col xs={24} lg={12}>
                    <AppointmentsTodayPieChart/>
                </Col>
                <Col xs={24} lg={12}>
                    <InvoiceStatusesRadial/>
                </Col>
            </Row>
